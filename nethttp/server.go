...
//默认忽略的统计trace
var defaultIgnorePath = []string{"healthz"}
...
func MWOmitURI(paths ...string) MWOption {
	return func(options *mwOptions) {
		options.omitPaths = paths
	}
}
